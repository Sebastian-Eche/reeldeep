...
public class DiffusionGrid : MonoBehaviour
{
    ...
    void OnDisable()
    {
        GameManager.Instance.OnBackgroundChange -= DelayedResizeGridToMatchSprite;
    }
    ...
    void DelayedResizeGridToMatchSprite(SpriteRenderer newBackground){
        StartCoroutine(DoDelayToResizeGridToMatchSprite(newBackground));
    }
